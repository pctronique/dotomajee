...
Pour créer un projet JEE avec docker.
...
Modifier le nom de la base de données dans le fichier « .env.local.example » et faire la modification dans le fichier « .env » (si celui-ci existe).
...
VALUE_TOMCAT_VERSION=10.1.24-jre21
